...
extern LIBCONFIG_API int config_setting_lookup_bool(
  const config_setting_t *setting, const char *name, bool *value);
...
extern LIBCONFIG_API int config_get_int(const config_t *config,
                                           const char *path, int defval);
...
extern LIBCONFIG_API int config_lookup_bool(const config_t *config,
                                            const char *path, int *value);
extern LIBCONFIG_API bool config_get_bool(const config_t *config,
                                            const char *path, bool defval);
extern LIBCONFIG_API int config_lookup_string(const config_t *config,
                                              const char *path,
                                              const char **value);
extern LIBCONFIG_API const char *config_get_string(const config_t *config,
                                              const char *path,
                                              const char *defval);
